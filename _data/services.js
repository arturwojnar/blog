...
export const services = [
  {
    ...
    pl: {
      ...
      points: [
        ...
        "Przejście z roli inżyniera do Tech Leada / Engineering Managera",
  ...
  },
  {
    ...
    en: {
      ...
      points: [
        "DDD — strategic & tactical modeling, boundaries, aggregates",
        "SDLC optimization — reducing lead time, decoupling delivery, flow",
        "AWS cloud cost reduction — spend audit, architecture-driven savings",
  ...
  },
  {
    ...
    en: {
      ...
      points: [
        ...
        "SDLC / delivery optimization",
        "AWS cost & architecture",
        "Data pipelines / warehouses reliability",
