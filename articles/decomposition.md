...
<article-image src="/public/articles/decomposition/1.webp" label=""></article-image>Figure 1. Services A, B, and C depend on one database.
...
<article-image src="/public/articles/decomposition/2.webp" label=""></article-image>Figure 2. Generalization results in one architectural quantum.
...
<article-image src="/public/articles/decomposition/3.webp" label=""></article-image>Figure 3. An outage in database C impacts only Service C.
...
<article-image src="/public/articles/decomposition/4.webp" label=""></article-image>Figure 4. Two networks. Each is independent with separate addresses pool.
...
<article-image src="/public/articles/decomposition/5.webp" label=""></article-image>Figure 5. A high-level picture on scalability of DynamoDB.
