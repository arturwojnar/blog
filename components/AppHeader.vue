  ...
  <header :class="alpine.header.position || 'left'">
    ...
    <div class="logo">
      <NuxtLink v-if="alpine.header.logo" to="/">
        <!-- Use regular img tags for SVG files to avoid IPX processing issues -->
        <img class="dark-img" :src="alpine.header.logo.pathDark" :alt="alpine.header.logo.alt" width="89" height="31" />
        <img class="light-img" :src="alpine.header.logo.path" :alt="alpine.header.logo.alt" width="89" height="31" />
      </NuxtLink>
